...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  const menuConfig = [
    ...
    { id: "hr", label: "HR Management", icon: <UserCircle size={18} />, roles: ["ADMIN"] },
    { id: "employee", label: "Employee Management", icon: <Users size={18} />, roles: ["HR"] },
    { id: "attendance", label: "Attendance", icon: <CalendarCheck size={18} />, roles: ["ADMIN", "HR", "EMPLOYEE"] },
    { id: "leaves", label: "Leave", icon: <FileSpreadsheet size={18} />, roles: ["ADMIN", "HR", "EMPLOYEE"] },
    { id: "payroll", label: "Payroll", icon: <Wallet size={18} />, roles: ["ADMIN", "HR", "EMPLOYEE"] },
    { id: "reports", label: "Reports", icon: <BarChart3 size={18} />, roles: ["ADMIN"] },
